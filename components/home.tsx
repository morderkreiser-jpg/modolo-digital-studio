...
const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: "These days, anyone looking for you starts on Google: if you don't show up, they find your competitor and choose them. I build real websites, made by hand and with proper SEO, so you turn up in the results when people nearby search for what you offer — and whoever lands books, calls or messages. I've done it for SaporiVivi, ZüriKey and BJ Studio, and for restaurants, practices, B&Bs and small shops across Switzerland. Building it, and replying to you, is always me.",
  ...
  de: {
    ...
    hero: {
      ...
      subtitle: "Wer dich sucht, beginnt heute bei Google: Wer dort nicht auftaucht, findet die Konkurrenz und wählt sie. Ich baue echte Websites, von Hand gemacht und mit sauberer SEO, damit du in den Suchergebnissen auftauchst, wenn Leute in der Nähe nach dem suchen, was du anbietest — und wer ankommt, reserviert, ruft an oder schreibt. Gemacht für SaporiVivi, ZüriKey und BJ Studio, und für Restaurants, Praxen, B&Bs und kleine Betriebe in der ganzen Schweiz. Gebaut und geantwortet wird immer von mir.",
  ...
  it: {
    ...
    hero: {
      ...
      subtitle: "Oggi chi ti cerca parte da Google: se non compari nei risultati, trova il concorrente e sceglie lui. Io costruisco siti veri, curati a mano e con la SEO fatta come si deve per uscire nelle ricerche — così compari quando in zona cercano quello che offri, e chi arriva prenota, chiama o scrive. L'ho fatto per SaporiVivi, ZüriKey e BJ Studio, e lo faccio per ristoranti, studi, B&B e piccole attività in tutta la Svizzera. A costruirlo, e a risponderti, ci sono sempre io.",
