      ...
      <section className="relative flex min-h-svh flex-col justify-center overflow-hidden px-6 sm:px-10 lg:px-16 pt-32 pb-20">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1400px]">
          ...
          <div className="mt-9 grid gap-8 md:grid-cols-[1fr_auto] md:items-end">
            <p className="mds-in max-w-xl text-base font-light leading-relaxed text-[#17130e]/60 sm:text-lg" style={{ animationDelay: "0.5s" }}>
              {t.hero.subtitle}
            </p>
            ...
            {PROJECTS.map((p) => (
              ...
              >
                ...
                <div className="relative mt-8 aspect-[1280/674] overflow-hidden rounded-[4px] bg-[#17130E] md:mt-10">
                  ...
                  <span className="pointer-events-none absolute bottom-4 right-4 flex translate-y-2 items-center gap-2 rounded-full px-4 py-2 text-sm tracking-wide text-[#F6F1E7] opacity-0 backdrop-blur transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100" style={{ background: "rgba(31,27,22,0.9)" }}>
        ...
        <div className="mx-auto max-w-[1400px]">
          ...
          <div className="grid gap-10 mds-split-4-8">
            ...
            <motion.div
              ...
              className="min-w-0"
            >
              <div className="grid gap-6 text-base font-light leading-relaxed md:grid-cols-2" style={{ color: "rgba(31,27,22,0.66)" }}>
                <p>{t.founder.bio1}</p>
                <p>{t.founder.bio2}</p>
              </div>
              ...
              <div className="mt-12 border-t" style={{ borderColor: "rgba(201,162,90,0.25)" }}>
                {t.values.map((value, i) => (
                  <div key={i} className="flex gap-6 border-b py-5" style={{ borderColor: "rgba(201,162,90,0.14)" }}>
                    ...
                    <div>
                      <h3 className="display-space text-lg" style={{ color: "#17130e" }}>{value.title}</h3>
                      <p className="mt-1 text-sm font-light" style={{ color: "rgba(31,27,22,0.5)" }}>{value.desc}</p>
                    </div>
                  </div>
                ))}
              </div>

              <p className="display-space mt-12" style={{ fontSize: "clamp(1.35rem, 2.4vw, 2rem)", lineHeight: 1.3, color: "#17130e" }}>{t.about.p3}</p>
            </motion.div>
          </div>
        </div>
      </section>
