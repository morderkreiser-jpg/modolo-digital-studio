      ...
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="mt-8 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div className="flex items-center gap-3">
            <Image src="/logo-mark-light.png" alt="Modolo Digital Studio" width={30} height={30} />
            <span className="micro-caps tnum" style={{ color: "rgba(251,248,242,0.55)" }}>© {year} Modolo Digital Studio</span>
          </div>
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
            <Link href={localizedHref(lang, "/impressum")} className="micro-caps transition-colors text-[color:rgba(251,248,242,0.6)] hover:text-[var(--paper)]">{t.imprint}</Link>
            <Link href={localizedHref(lang, "/privacy")} className="micro-caps transition-colors text-[color:rgba(251,248,242,0.6)] hover:text-[var(--paper)]">{t.privacy}</Link>
